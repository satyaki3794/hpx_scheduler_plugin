...
#define HPX_REGISTER_HIERARCHY_SCHEDULER_PLUGIN_FACTORY(SchedulerPlugin, pluginname)                                            \
    HPX_REGISTER_SCHEDULER_PLUGIN_FACTORY_BASE(                                                                       \
        hpx::threads::policies::hierarchy_scheduler_plugin_factory<SchedulerPlugin>, pluginname)           \
    HPX_DEF_UNIQUE_PLUGIN_NAME(                                                                                       \
        hpx::threads::policies::hierarchy_scheduler_plugin_factory<SchedulerPlugin>, pluginname)           \
    template struct hpx::threads::policies::hierarchy_scheduler_plugin_factory<SchedulerPlugin>;           \
