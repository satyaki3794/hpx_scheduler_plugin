...
namespace hpx{ namespace threads { namespace policies
{
    ...
    struct local_priority_queue_scheduler_plugin_factory : public scheduler_plugin_factory_base
    {
        local_priority_queue_scheduler_plugin_factory(hpx::util::section const* global_cfg,
