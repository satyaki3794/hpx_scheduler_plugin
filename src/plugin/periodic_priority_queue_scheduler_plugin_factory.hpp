...
#if !defined(HPX_PERIODIC_PRIORITY_SCHEDULER_PLUGIN_FACTORY)
#define HPX_PERIODIC_PRIORITY_SCHEDULER_PLUGIN_FACTORY
...
namespace hpx{ namespace threads { namespace policies
{
    ...
    struct periodic_priority_queue_scheduler_plugin_factory : public scheduler_plugin_factory_base
    {
        periodic_priority_queue_scheduler_plugin_factory(hpx::util::section const* global_cfg,
        ...
        {
            if (is_enabled_){
                typedef hpx::threads::policies::periodic_priority_queue_scheduler<> sh;
