...
#if !defined(HPX_STATIC_SCHEDULER_PLUGIN_FACTORY)
#define HPX_STATIC_SCHEDULER_PLUGIN_FACTORY
...
namespace hpx{ namespace threads { namespace policies
{
    ...
    struct static_queue_scheduler_plugin_factory : public scheduler_plugin_factory_base
    {
        static_queue_scheduler_plugin_factory(hpx::util::section const* global_cfg,
        ...
        {
            if (is_enabled_){
                typedef hpx::threads::policies::static_queue_scheduler<> sh;
...
/// Hpx.Plugin.
#define HPX_REGISTER_SQ_SCHEDULER_PLUGIN_FACTORY(SchedulerPlugin, pluginname)                                            \
    HPX_REGISTER_SCHEDULER_PLUGIN_FACTORY_BASE(                                                                       \
        hpx::threads::policies::static_queue_scheduler_plugin_factory<SchedulerPlugin>, pluginname)           \
    HPX_DEF_UNIQUE_PLUGIN_NAME(                                                                                       \
        hpx::threads::policies::static_queue_scheduler_plugin_factory<SchedulerPlugin>, pluginname)           \
    template struct hpx::threads::policies::static_queue_scheduler_plugin_factory<SchedulerPlugin>;           \
