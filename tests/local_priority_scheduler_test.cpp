...
#include "../src/plugin/local_priority_queue_scheduler.hpp"
#include "../src/plugin/local_priority_queue_scheduler_plugin_factory.hpp"
...
///////////////////////////////////////////////////////////////////////////////
bool test_local_priority_scheduler(hpx::util::section& ini)
{
...
int main(int argc, char* argv[])
{
    ...
    test_local_priority_scheduler(hpx::get_runtime().get_config());
