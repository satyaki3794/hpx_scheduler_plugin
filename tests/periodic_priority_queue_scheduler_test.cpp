...
#include "../src/plugin/periodic_priority_queue_scheduler.hpp"
#include "../src/plugin/periodic_priority_queue_scheduler_plugin_factory.hpp"
...
///////////////////////////////////////////////////////////////////////////////
bool test_periodic_priority_queue_scheduler(hpx::util::section& ini)
{
    ...
    for (iterator i = s.begin (); i != end; ++i)
    {
        ...
        try {
            ...
            // now test for periodic priority queue scheduler plugin
            typedef hpx::threads::policies::periodic_priority_queue_scheduler<> ppq;
            hpx::threads::policies::scheduler_base* base = plugin.get();
            HPX_TEST(dynamic_cast<ppq*>(base) != NULL);
        }
        catch(...) {
...
int main(int argc, char* argv[])
{
    ...
    test_periodic_priority_queue_scheduler(hpx::get_runtime().get_config());
