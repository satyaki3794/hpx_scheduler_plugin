...
///////////////////////////////////////////////////////////////////////////////
bool test_static_priority_scheduler(hpx::util::section& ini)
{
    ...
    for (iterator i = s.begin (); i != end; ++i)
    {
        ...
        try {
            ...
            typedef hpx::threads::policies::static_priority_queue_scheduler<> lpq;
...
int main(int argc, char* argv[])
{
    ...
    test_static_priority_scheduler(hpx::get_runtime().get_config());
